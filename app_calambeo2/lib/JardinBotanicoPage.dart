...
class JardinBotanicoPage extends StatefulWidget {
  @override
  _JardinBotanicoPageState createState() => _JardinBotanicoPageState();
}

class _JardinBotanicoPageState extends State<JardinBotanicoPage> {
  late GoogleMapController mapController;
  final Completer<GoogleMapController> _controller =
      Completer<GoogleMapController>();

  final LatLng _center = const LatLng(
      4.44996252894079, -75.22300399029223); // Coordenadas de Ibagué
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('Jardín Botánico San Jorge'),
              ...
              child: Column(
                ...
                children: [
                  ...
                  _buildCard(
                    ...
                    content: Text(
                      'Jardín con 62 hectáreas que ofrece caminatas ecológicas, avistamiento de aves y actividades educativas. Costo de entrada: 15.000. '
