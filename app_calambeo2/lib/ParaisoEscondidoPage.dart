...
class ParaisoEscondidoPage extends StatefulWidget {
  @override
  _ParaisoEscondidoPageState createState() => _ParaisoEscondidoPageState();
}

class _ParaisoEscondidoPageState extends State<ParaisoEscondidoPage> {
  late GoogleMapController mapController;
  final Completer<GoogleMapController> _controller =
      Completer<GoogleMapController>();

  final LatLng _center = const LatLng(
      4.463860943860872, -75.19799607861214); // Coordenadas de Ibagué
              ...
              child: Column(
                ...
                children: [
                  ...
                  _buildCard(
                    ...
                    content: Text(
                      'Cabaña privada rodeada de naturaleza y vida silvestre, ideal para disfrutar en familia o pareja. Contamos con piscina pequeña y avistamiento de aves.'
                      'La mejor vista a la ciudad en un entorno natural.',
