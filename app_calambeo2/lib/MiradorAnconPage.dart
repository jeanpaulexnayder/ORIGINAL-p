...
class MiradorAnconPage extends StatefulWidget {
  @override
  _MiradorAnconPageState createState() => _MiradorAnconPageState();
}

class _MiradorAnconPageState extends State<MiradorAnconPage> {
  late GoogleMapController mapController;
  final Completer<GoogleMapController> _controller =
      Completer<GoogleMapController>();

  final LatLng _center = const LatLng(
      4.4608213637103, -75.23160460980239); // Coordenadas de Ibagué
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('Mirador Ancón Tesorito'),
                ...
                children: [
                  ...
                  _buildCard(
                    ...
                    content: Column(
                      ...
                      children: [
                        Text(
                          'Unnamed Road, Ibagué, Tolima',
                          style: TextStyle(fontSize: 16),
                        ),
                        SizedBox(height: 10),
                        Text(
                          "Telefono: '315 623 0419 - 317 019 5900'",
                          style: TextStyle(fontSize: 16),
                        ),
                      ],
                    ),
